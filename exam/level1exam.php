...
<div class="container my-5">
    ...
    <?php if(isset($_SESSION["errors"])){?>
            <div class="alert alert-danger">
                    <p class="text-center"> <?php echo $_SESSION["errors"][0] ?></p>
            </div>
        <?php } ?>
        ...
        <?php 
            ...
            $sql = "SELECT COUNT(id) AS questions FROM level1";
        ...
        <div class="text-center">
            ...
            <a class="btn btn-danger m-5" href="handlers/handledeletelevel1.php">DELETE EXAM 1</a>
        </div>
        <div class="row">

        <form class="text-center m-auto" action="handlers/handleexam1.php" method="post">
