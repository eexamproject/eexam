...
<div class="container my-5">
    ...
    <?php if(isset($_SESSION["errors"])){?>
        ...
        <h1 class="text-center mb-5">LEVEL 4 EXAM</h1>
        <?php 
            include('classes/db.php');
            $sql = "SELECT COUNT(id) AS questions FROM level4";
        ...
        <div class="text-center">
            ...
            <a class="btn btn-danger m-5" href="handlers/handledeletelevel4.php">DELETE EXAM 4</a>
        </div>
        <div class="row">

        <form class="text-center m-auto" action="handlers/handleexam4.php" method="post">
